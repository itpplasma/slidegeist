...
def test_translate_url_tugraz_portal_to_paella():
...
def test_translate_url_tugraz_portal_http():
...
def test_translate_url_tugraz_paella_unchanged():
...
def test_translate_url_other_urls_unchanged():
